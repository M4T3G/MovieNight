...
public class EventParticipantRequestDetailScreen extends JFrame {
    private Color backgroundColor = Color.WHITE;
    private Color accentColor = new Color(255, 89, 56);
    private Color darkBackgroundColor = new Color(31, 37, 49);
    private Color textColor = Color.BLACK;
    
    public EventParticipantRequestDetailScreen(String movieName, String genre, String dateTime, String location, 
        ...
        JPanel bottomPanel = createBottomPanel(currentParticipants, maxParticipants,db_helper,kullanici,etkinlikId);
    ...
    private JPanel createBottomPanel(String currentParticipants, String maxParticipants,DbHelper db_helper,Kullanici kullanici,int etkinlikId) {
        JPanel panel = new JPanel();
        panel.setLayout(new BoxLayout(panel, BoxLayout.Y_AXIS));
        panel.setBackground(backgroundColor);
        ...
        JButton joinButton = new JButton("Katılım isteği yolla.");
        ...
        // Butona işlevsellik ekleme
        joinButton.addActionListener(e -> {
        	Etkinlik etkinlik=new Etkinlik();
        	
        	try {
        	    etkinlik.attendanceRequest(etkinlikId, kullanici.getKullanici_adi(),db_helper);
