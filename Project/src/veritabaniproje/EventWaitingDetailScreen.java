...
public class EventWaitingDetailScreen extends JFrame {
    private Color backgroundColor = Color.WHITE;
    private Color accentColor = new Color(255, 89, 56);
    private Color darkBackgroundColor = new Color(31, 37, 49);
    private Color textColor = Color.BLACK;
    
    public EventWaitingDetailScreen(String movieName, String genre, String dateTime, String location, 
    ...
    private JPanel createBottomPanel(String currentParticipants, String maxParticipants,DbHelper db_helper,Kullanici kullanici,int etkinlikId) {
        ...
        JButton joinButton = new JButton("Katılım Talebini Iptal Et");
        ...
        joinButton.addActionListener(e -> {
        	...
        	try {
        	    etkinlik.deleteAttendanceRequest(etkinlikId, kullanici.getKullanici_adi(), db_helper);
